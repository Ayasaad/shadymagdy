            ...
            <div id="Div1" style="">
                <div id="rep1" style="">
                    <div dir="rtl" style="text-align: right; margin: 0 auto; padding: 5px; border: 1px solid orange; height: auto; width: 21cm; box-shadow: 5px 5px 15px #999;">
                        ...
                        <div>
                            <p style="padding: 5px 0; font-size: 24px; line-height: 28px; text-align: left;">المنجز
                              <?php echo   date("d-m-Y") ;?> <span style="display: block; font-size: 14px; color: #999;" class="muted">تقرير الاجراءات المنجزة</span></p>
                        </div>
                        ...
                        <tbody>
                          ...
                          $query= mysql_query("SELECT * FROM vwmongaz limit 300");
                          $tablerows='';
