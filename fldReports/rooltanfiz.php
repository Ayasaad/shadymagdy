...
<?php 
                         ...
                         $query= mysql_query("SELECT *,(select count(id) from vwroolall  WHERE IDEventType = 6) as cotevts  FROM vwroolall  WHERE IDEventType = 6");
                          $tablerows='';
                      ...
                      <span style="font-family:Arial;font-size: 13px;">'.$row["TheDate"].'</span>   /  <span style="font-size: 10px;color:#AF0100;">'. $row["TypeName"] .'</span> <br />
                      ...
                      <span style="font-family:Arial;font-size: 12px;color:#863B20;"> '.$row["Circle"].'</span><br />
                      <span style="font-family:Arial;font-size: 12px;color:#863B20;">  الدرجة : '. $row["positionName"] .'</span> 
                      </td>
            ...
            <div id="Div1" style="">
                <div id="rep1" style="">
                    <div dir="rtl" style="text-align: right; margin: 0 auto; padding: 5px; border: 1px solid orange; height: auto; width: 21cm; box-shadow: 5px 5px 15px #999;">
                        ...
                        <div>
                            <p style="padding: 5px 0; font-size: 24px; line-height: 28px; text-align: left;">الرول - (التنفيذ)
