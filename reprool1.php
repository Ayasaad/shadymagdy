            ...
            <div id="Div1" style="">
                <div id="rep1" style="">
                    <div dir="rtl" style="text-align: right; margin: 0 auto; padding: 5px; border: 1px solid orange; height: auto; width: 21cm; box-shadow: 5px 5px 15px #999;">
                        ...
                        <div>
                            <p style="padding: 5px 0; font-size: 24px; line-height: 28px; text-align: left;">الرول
                              <?php echo   date("d-m-Y") ;?> <span style="display: block; font-size: 14px; color: #999;" class="muted">تقرير الرول</span></p>
                        </div>


                        <div style="margin: 40px 0 20px 0; border-top: 1px solid gray"></div>

                        <table  class="print tablesorter" cellspacing="0">
                          <thead>
                             <tr style="font-size: 14px; background:#D4D3D3;">
                                ...
                                <th  style="width: 75px;font-size: 12px;">الجهة - رقم القضية</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                          ...
                          $query= mysql_query("SELECT * FROM vwroolall ");
                          $tablerows='';
                      ...
                      <td>
                      <a style="font-family:Arial;font-size: 12px; color:#E91E63;" target="_blank" href="../index.php?cccd='.$row["id"] .'&mark=1">'.$row["Code"] .'</a><br /> 
                      ...
                      <span style=" font-family:Arial;font-size: 10px; color:#4CAF50;">'.$row["PositionNames"].' </span> <br />
                      ...
                      <span style="font-family:Arial;font-size: 13px;">'.$row["TheDate"].'</span><br />
                      <span style=" font-weight: bold;  font-family:Arial;font-size: 13px;">  '.$row["DetailsEvent"].' </span><br /> 
                      <span style="font-size: 10px;color:#AF0100;">'. $row["TypeName"] .'</span> <br />
                      <span style=" font-size: 12px;border-top: 1px solid #ccc;">  '.$row["prev_value"].' </span>
                      </td>

                      <td>
                      <span style="font-family:Arial;font-size: 12px;color:#863B20;">  الطابق : '.$row["Floor"].'</span> <br />
                      <span style="font-family:Arial;font-size: 12px;color:#863B20;">  القاعة : '. $row["Hall"]  . '</span><br />
                      <span style="font-family:Arial;font-size: 12px;color:#863B20;">  السكرتير : '. $row["Secretary"] .'</span> 
                      </td>

                      <td>
                       <span style="font-family:Arial;font-size: 14px;color:#1E88E5;">'.$row["CourtName"].'</span> <br /> 
                      <span style="font-family:Arial;font-size: 12px;color:#863B20;">  الدائرة : '.$row["Circle"].'</span>
                      </td>
