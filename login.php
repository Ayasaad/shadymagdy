...
<head>
	<meta charset="utf-8" />
	<title>المحامي الآلي | المرشد للبرمجيات والتكنولوجيا</title>
...
<body class="login">
	...
	<div class="logo">
		...
		<h2>   <span style="color: red; font-family: Segoe UI"><span style="color: white;">المحامي </span>الآلي</span></h2>
	</div>
	<!-- END LOGO -->
	<!-- BEGIN LOGIN -->
	<div class="content">
		<!-- BEGIN LOGIN FORM -->
		<form class="form-vertical login-form" action="init.php" method="post">
			<h3 class="form-title">تسجيل الدخول لحسابك</h3>
			...
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-user"></i>
						<input class="m-wrap placeholder-no-fix" type="text" placeholder="اسم المستخدم" autocomplete="off" name="username"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						<i class="icon-lock"></i>
						<input class="m-wrap placeholder-no-fix" type="password" placeholder="كلمة المرور" autocomplete="off" name="password"/>
					</div>
				</div>
			</div>
			<div class="control-group">
				...
				<div class="controls">
					<div class="input-icon left">
						...
						<select id="clintID" name="clintID">
							<option value="101">مكتب فواز</option>
							<option value="102">مكتب هنادي</option>
							<option value="103">مكتب نواف</option>
							<option value="104">مكتب عبد القدوس</option>
						</select>
					</div>
				</div>
			</div>
			...
			<div class="forget-password">
				...
				<p>
					لا مشكلة, اضغط <a href="javascript:;"  id="forget-password">هنا</a>
					لاعادة ضبط كلمة المرور.
				</p>
			</div>
			<div class="create-account">
				<p>
					ليس لديك حساب بعد ؟&nbsp; 
					<a href="javascript:;" id="register-btn" >انشاء حساب جديد</a>
				</p>
			</div>
		</form>
		<!-- END LOGIN FORM -->        
	...
	<!-- BEGIN COPYRIGHT -->
	<div class="copyright">
		2016 &copy; المحامي الالي من المرشد للبرمجبات.
	</div>
	<!-- END COPYRIGHT -->
