...
<head>
	...
	<link href="assets/css/pages/error-rtl.css" rel="stylesheet" type="text/css"/>
...
<body class="page-404-3">
	<div class="page-inner">
		<img src="assets/img/pages/earth-rtl.jpg" alt="">
	</div>
	<div class="container error-404">
		<h1>الصلاحية غير متاحة.</h1>
		<h2>ربما يكون هذا القسم خارج مجموعة صلاحياتك.</h2>
		<p>
			بامكانت, طلب الصلاحية من المسؤل واعادة المحاولة فيما بعد. 
		</p>
		<p>
			<a href="index.html">اطلب صلاحية</a>
			<br>
		</p>
	</div>
